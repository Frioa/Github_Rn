...
export default class NavigationBar extends Component{
    ...
    render() {
        ...
        let titleView = this.props.titleView ? this.props.titleView : // 如果用户自定义View用用户的View
            <Text ellipsizeMode="head" numberOfLines={1} style={styles.title}>{this.props.title}</Text>;// ellipsizeMode="head"  ...xyz 显示省略号
